...
namespace Random
{
    public class DirectionalProcessColumn : DirectionalProcess
    {
        public DirectionalProcessColumn(Grid grid):base(Enums.Direction.Column, grid) { }
        ...
        public override List<ConsecEmptyInsertionSpace> GetEmptyConsecSpace(string word)
        {
            ...
            {
                var tile = _grid.GridData[i][StartRowCol];
        ...
        public override List<JoinedInsertionSpace> GetJoinedSpace(string word)
        {
            ...
            for (var i = 0; i < currentLetters.Count; i++)
            {
                ...
                do
                {
                    ...
                    {
                        var tile = _grid.GridData[q][StartRowCol];
